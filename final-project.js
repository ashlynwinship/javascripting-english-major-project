...
pilatesMarker = L.marker(pilates).addTo(deriveMap).bindPopup("Pilates place");
...
subStation = L.marker([40.713011, -74.00328]).addTo(deriveMap).bindPopup("Brooklyn Bridge-City Hall/Chambers Street Station");
lafAndWorth = L.marker([40.715496, -74.003032]).addTo(deriveMap).bindPopup("Turn here onto Worth.");
